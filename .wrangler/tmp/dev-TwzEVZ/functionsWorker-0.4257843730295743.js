...
// .wrangler/tmp/bundle-z2RQFa/checked-fetch.js
...
// .wrangler/tmp/pages-xfwBUE/functionsWorker-0.4257843730295743.mjs
      ...
      route(path, app10) {
        ...
        app10.routes.map((r) => {
          ...
          if (app10.errorHandler === errorHandler) {
            ...
            handler = /* @__PURE__ */ __name2(async (c, next) => (await compose([], app10.errorHandler)(c, () => r.handler(c, next))).res, "handler");
...
var db_exports = {};
__export(db_exports, {
  TIMELINE_TAG_MAP: /* @__PURE__ */ __name(() => TIMELINE_TAG_MAP, "TIMELINE_TAG_MAP"),
  TIMELINE_TAG_NAMES: /* @__PURE__ */ __name(() => TIMELINE_TAG_NAMES, "TIMELINE_TAG_NAMES"),
  bulkSaveTimelineEvents: /* @__PURE__ */ __name(() => bulkSaveTimelineEvents, "bulkSaveTimelineEvents"),
  createSession: /* @__PURE__ */ __name(() => createSession, "createSession"),
  createUser: /* @__PURE__ */ __name(() => createUser, "createUser"),
  deleteExpiredSessions: /* @__PURE__ */ __name(() => deleteExpiredSessions, "deleteExpiredSessions"),
  deleteSession: /* @__PURE__ */ __name(() => deleteSession, "deleteSession"),
  deleteShowcase: /* @__PURE__ */ __name(() => deleteShowcase, "deleteShowcase"),
  deleteSong: /* @__PURE__ */ __name(() => deleteSong, "deleteSong"),
  deleteTimelineEvent: /* @__PURE__ */ __name(() => deleteTimelineEvent, "deleteTimelineEvent"),
  deleteUser: /* @__PURE__ */ __name(() => deleteUser, "deleteUser"),
  getDynamics: /* @__PURE__ */ __name(() => getDynamics, "getDynamics"),
  getLiveStatus: /* @__PURE__ */ __name(() => getLiveStatus, "getLiveStatus"),
  ...
  getUserInfo: /* @__PURE__ */ __name(() => getUserInfo, "getUserInfo"),
  getUsers: /* @__PURE__ */ __name(() => getUsers, "getUsers"),
  resolveTag: /* @__PURE__ */ __name(() => resolveTag, "resolveTag"),
  saveDynamic: /* @__PURE__ */ __name(() => saveDynamic, "saveDynamic"),
  saveLiveStatus: /* @__PURE__ */ __name(() => saveLiveStatus, "saveLiveStatus"),
  saveShowcase: /* @__PURE__ */ __name(() => saveShowcase, "saveShowcase"),
  saveSong: /* @__PURE__ */ __name(() => saveSong, "saveSong"),
  saveTimelineEvent: /* @__PURE__ */ __name(() => saveTimelineEvent, "saveTimelineEvent"),
  saveUserInfo: /* @__PURE__ */ __name(() => saveUserInfo, "saveUserInfo"),
  updateUserPassword: /* @__PURE__ */ __name(() => updateUserPassword, "updateUserPassword"),
  updateUserRole: /* @__PURE__ */ __name(() => updateUserRole, "updateUserRole")
});
...
var TIMELINE_TAG_MAP;
var TIMELINE_TAG_NAMES;
var init_db = __esm({
  "lib/db.ts"() {
    "use strict";
    init_functionsRoutes_0_9050978634056555();
    init_checked_fetch();
    __name2(saveDynamic, "saveDynamic");
    __name2(getDynamics, "getDynamics");
    __name2(saveUserInfo, "saveUserInfo");
    __name2(getUserInfo, "getUserInfo");
    __name2(saveLiveStatus, "saveLiveStatus");
    __name2(getLiveStatus, "getLiveStatus");
    TIMELINE_TAG_MAP = {
      "\u9996\u64AD": { color: "purple", icon: "\u{1F3A4}" },
      "\u6B4C\u56DE": { color: "green", icon: "\u{1F3B5}" },
      "\u904A\u6232": { color: "teal", icon: "\u{1F3AE}" },
      "\u89C6\u9891\u6295\u7A3F": { color: "cyan", icon: "\u{1F4F9}" },
      "3D\u62AB\u9732": { color: "violet", icon: "\u{1F464}" },
      "\u65B0\u8863\u88DD": { color: "orange", icon: "\u{1F457}" },
      "\u7D00\u5FF5\u56DE": { color: "red", icon: "\u{1F3C6}" },
      "\u806F\u52D5": { color: "blue", icon: "\u{1F91D}" },
      "\u91CD\u8981": { color: "red", icon: "\u2B50" },
      "\u751F\u65E5": { color: "yellow", icon: "\u{1F382}" },
      "\u5468\u5E74": { color: "amber", icon: "\u{1F389}" },
      "\u6D3B\u52D5": { color: "slate", icon: "\u{1F4C5}" },
      "\u65E5\u5E38": { color: "gray", icon: "\u{1F4DD}" }
    };
    TIMELINE_TAG_NAMES = Object.keys(TIMELINE_TAG_MAP);
    ...
    __name2(getUserByUsername, "getUserByUsername");
    ...
    __name2(deleteExpiredSessions, "deleteExpiredSessions");
    __name2(updateUserPassword, "updateUserPassword");
    __name2(getUsers, "getUsers");
    __name2(updateUserRole, "updateUserRole");
    __name2(deleteUser, "deleteUser");
    __name2(getSongs, "getSongs");
    __name2(saveSong, "saveSong");
    __name2(deleteSong, "deleteSong");
    __name2(getShowcases, "getShowcases");
    __name2(saveShowcase, "saveShowcase");
    __name2(deleteShowcase, "deleteShowcase");
  }
});
...
var init_cookies = __esm({
  "api/utils/cookies.ts"() {
    ...
    __name2(isSecureCookieEnabled, "isSecureCookieEnabled");
...
var init_auth = __esm({
  "api/middleware/auth.ts"() {
    ...
    requireEditor = /* @__PURE__ */ __name2(async (c, next) => {
...
var init_showcases = __esm({
  "api/routes/showcases.ts"() {
    ...
    init_auth();
    app5 = new Hono2();
    __name2(getMaxModelNumber, "getMaxModelNumber");
    __name2(updateShowcaseFolder, "updateShowcaseFolder");
    app5.get("/", async (c) => {
...
var init_r2 = __esm({
  "api/utils/r2.ts"() {
    ...
    init_functionsRoutes_0_9050978634056555();
    init_checked_fetch();
    __name2(isLocalDevEnv, "isLocalDevEnv");
    __name2(buildR2Url, "buildR2Url");
  }
});
var app6;
var r2_default;
...
var init_route = __esm({
  "api/[[route]].ts"() {
    ...
    onRequest = /* @__PURE__ */ __name2((context) => app9.fetch(context.request, context.env, context.executionCtx), "onRequest");
  }
});
var routes;
var init_functionsRoutes_0_9050978634056555 = __esm({
  "../.wrangler/tmp/pages-xfwBUE/functionsRoutes-0.9050978634056555.mjs"() {
    "use strict";
    init_route();
    routes = [
      {
...
// .wrangler/tmp/bundle-z2RQFa/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-z2RQFa/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.4257843730295743.js.map
