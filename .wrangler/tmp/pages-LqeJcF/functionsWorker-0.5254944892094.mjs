...
// ../.wrangler/tmp/bundle-Pxha99/checked-fetch.js
...
var requireEditor = /* @__PURE__ */ __name(async (c, next) => {
...
app.get("/api/live", async (c) => {
  try {
    ...
    return c.json({ isLive: false, lastChecked: (/* @__PURE__ */ new Date()).toISOString() });
  } catch {
    return c.json({ isLive: false, lastChecked: (/* @__PURE__ */ new Date()).toISOString() });
  }
});
...
// ../.wrangler/tmp/pages-LqeJcF/functionsRoutes-0.8560812052896127.mjs
var routes = [
  {
    routePath: "/api/:route*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-Pxha99/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Pxha99/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5254944892094.mjs.map
